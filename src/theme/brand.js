...
const brand = {
  ...
  //
  // It does NOT match the logo, on purpose: the eZONE mark says which family
  // this app belongs to, the name says which app it is. A receipt therefore
  // carries the eZONE lockup and reads "Generated by CBA-Agent".
  appName: 'CBA-Agent',
  /**
